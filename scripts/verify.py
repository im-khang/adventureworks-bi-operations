...
REQUIRED = ['README.md', 'LICENSE', '.gitignore', 'requirements.txt', 'data/raw/.gitkeep', 'data/interim/.gitkeep', 'data/processed/.gitkeep', 'docs', 'reports', 'references', 'dashboard', 'dashboard/AdventrureWorks_report.pbit', 'reports/figures/Cost_Analysis.png', 'reports/figures/Procurement_Overview.png', 'reports/CASE_RESULT.md', 'data/README.md']


def fail(msg: str) -> int:
    print(f"verify_failed project=adventureworks-bi-operations reason={msg}")
    return 1
...
def main() -> int:
    ...
    if "adventureworks-bi-operations" == "olist-delivery-sla-risk-analytics":
    ...
    print("verify_ok project=adventureworks-bi-operations")
    return 0
